...

 {
  final List<Browse> allBrowses = [
    ...
    Browse(
      ...
      topImageUrl: 'assets/images/blueGumNut.png',
      ...
      flowersImageUrl: 'assets/images/blueGumFlower.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
    Browse(
      id: '3',
      commonName: 'Banksia',
      latinName: 'Banksia',
      topImageUrl: 'assets/images/Banksia_04_M_Morey_flower_COPYRIGHT.png',
      description: 'description',
      leafShape: 'description',
      leafImageUrl: 'assets/images/Banksia_09_M_Morey_leaf_COPYRIGHT.png',
      plantShape: 'description',
      plantImageUrl: 'assets/images/Banksia_08_M_Morey_tree.png',
      barkTexture: 'description',
      barkImageUrl: 'assets/images/Banksia_06_M_Morey_bark_COPYRIGHT.png',
      flowers: 'descriptiond',
      flowersImageUrl: 'assets/images/Banksia_04_M_Morey_flower_COPYRIGHT.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
      Browse(
      id: '4',
      ...
      topImageUrl: 'assets/images/Callistemon_flower.png',
      description: 'description',
      leafShape: 'description',
      leafImageUrl: 'assets/images/Callistemon_leaf.png',
      plantShape: 'description',
      plantImageUrl: 'assets/images/Callistemon_tree.png',
      barkTexture: 'description',
      barkImageUrl: 'assets/images/Callistemon_nuts.png',
      flowers: 'descriptiond',
      flowersImageUrl: 'assets/images/Callistemon_flower.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
      Browse(
      id: '5',
      commonName: 'Camellia',
      latinName: 'Camellia',
      topImageUrl: 'assets/images/Camellia_M_Morey_flower_COPYRIGHT.png',
      description: 'description',
      leafShape: 'description',
      leafImageUrl: 'assets/images/Camellia_M_Morey_leaf_COPYRIGHT.png',
      plantShape: 'description',
      plantImageUrl: 'assets/images/Camellia_M_Morey_tree.png',
      barkTexture: 'description',
      barkImageUrl: 'assets/images/Camellia_M_Morey_nut.png',
      flowers: 'descriptiond',
      flowersImageUrl: 'assets/images/Camellia_M_Morey_flower_COPYRIGHT.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
      Browse(
      id: '6',
      commonName: 'Correa',
      latinName: 'Correa',
      topImageUrl: 'assets/images/Correa_M_Morey_flower_COPYRIGHT.png',
      description: 'description',
      leafShape: 'description',
      leafImageUrl: 'assets/images/Correa_M_Morey_leaf_COPYRIGHT.png',
      plantShape: 'description',
      plantImageUrl: 'assets/images/Correa_M_Morey_tree.png',
      barkTexture: 'description',
      barkImageUrl: 'assets/images/Correa_M_Morey_tree.png',
      flowers: 'descriptiond',
      flowersImageUrl: 'assets/images/Correa_M_Morey_flower_COPYRIGHT.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
      Browse(
      id: '7',
      ...
      latinName: 'Grevillea',
      topImageUrl: 'assets/images/Grevillea_M_Morey_flower_COPYRIGHT.png',
      description: 'description',
      leafShape: 'description',
      leafImageUrl: 'assets/images/Grevillea_M_Morey_tree_COPYRIGHT.png',
      plantShape: 'description',
      plantImageUrl: 'assets/images/Grevillea_M_Morey_tree.png',
      barkTexture: 'description',
      barkImageUrl: 'assets/images/Grevillea_M_Morey_tree.png',
      flowers: 'descriptiond',
      flowersImageUrl: 'assets/images/Grevillea_M_Morey_flower_COPYRIGHT.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
      Browse(
      id: '8',
      ...
      topImageUrl: 'assets/images/Lilly_Pilly_M_Morey_leaf_COPYRIGHT.png',
      description: 'description',
      leafShape: 'description',
      leafImageUrl: 'assets/images/Lilly_Pilly_M_Morey_leaf_COPYRIGHT.png',
      plantShape: 'description',
      plantImageUrl: 'assets/images/Lilly_Pilly_M_Morey_tree.png',
      barkTexture: 'description',
      barkImageUrl: 'assets/images/Lilly_Pilly_M_Morey_tree.png',
      flowers: 'descriptiond',
      flowersImageUrl: 'assets/images/Lilly_Pilly_M_Morey_leaf_COPYRIGHT.png',
      harvestingVideos: ['assets/videos/BWRAC_Eucalypt_Browse.mp4'],
    ),
  ];
