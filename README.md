...
linux, web, macOS and windows 
Configuration files for the respective platforms. As this app is intended for mobile platforms 
only, these directories can be ignored. Note only linux, macOS and windows can be deleted 
as web is needed to do quick tests in Chrome. 
...
just pass flutter pub add <package_name> to VScode’s terminal and restart VScode. 