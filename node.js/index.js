...
app.post('/create-delivery', async (req, res) => {
  ...
  try {
    const { name, address, specifications, items } = req.body;
    ...
    const result = await client.query(
      `SELECT create_full_delivery($1, $2, $3, $4::delivery_item_type[]) AS delivery_id`,
      [name, address, specifications, pgItemsArray]
    );
