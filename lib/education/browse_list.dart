...
class _BrowseListPageState extends State<BrowseListPage> {
  final List<Browse> allBrowses = [
    ...
    Browse(
      ...
      description: 'Banksia is a flowering shrub or tree of the Proteaceae family. They are evergreen plants. They range from <1 metre to over 20 metres. Mostly located in temperate areas, though some are in arid and tropical areas, species is endemic to Australia except for one which is both native to New Guinea and Australia',
      leafShape: 'Most leaves of the Banksia are green and get wider as they near the end of the leaf before sharply curving in, forming a semi-cirle',
      leafImageUrl: 'assets/images/Banksia_09_M_Morey_leaf_COPYRIGHT.jpg',
      plantShape: 'Some Banksia look like a shrub while others look like a normal, standard tree',
      plantImageUrl: 'assets/images/Banksia_08_M_Morey_tree.jpg',
      barkTexture: 'For Banksia species that are trees, they have a rough texture and are coloured with different shades of browns with both light and dark shades present',
      barkImageUrl: 'assets/images/Banksia_06_M_Morey_bark_COPYRIGHT.jpg',
      flowers: 'The flowers of a Banksia are unique as they look like a large cylinder, usually yellow, but red, orange, pink and purple flowers do exist. Their flowers are long, thin lines surrounding the core of where they grow out from ',
    ...
    Browse(
      ...
      barkTexture: 'Jagged and rough looking bark ranging from feeling hard to almost soft and like paper',
    ...
    Browse(
      ...
      description: "Cammellia is a large flowering plant belonging to Theaceae family, they are evergreen plants with some species reaching heights of above 10 metres. The species is not native to Australia, with it having been imported in the 1800's",
      leafShape: 'The leaves of a Camellia plant are long and wide with an almost leathery feel to them, they are a deep green colour with a glossy look to them',
      ...
      barkTexture: 'The texture of the Camellia bark is smooth, it has a range of colours from biege to a dull brown',
      barkImageUrl: 'assets/images/Camellia_M_Morey_nut.jpg',
      flowers: 'The flowers of the plant usually have a red or pink colour to them but some species have white petals',
    ...
    Browse(
      ...
      description: 'Correa is a genus of 11 flowering plants which belong to the Rutaceae family. They are an evergreen plant, they average a few metres tall, although one species can reach up to 16 metres. It is endemic to Australia with each state having at least 1 species native to there. Victoria has 6 Correa native to it',
      leafShape: 'Leaves of the Correa plant are green, they sport a circular and oval shape to them',
      leafImageUrl: 'assets/images/Correa_M_Morey_leaf_COPYRIGHT.jpg',
      plantShape: 'Due to the number of different species, the plant can take on different looks, such as a dense small bush, or branching tower of sticks',
      ...
      flowers: 'The colours of the Correa plant can range from green, pink, white, greyish-purple. Every species generally holds the same shape of 4 petals stretching out, making a tube shape before flairing out, with the stamens sticking out',
    ...
    Browse(
      ...
      description: 'Grevillea is a flowering plant belonging to the Proteaceae family. Grevilleas are a type of evergreen plant. The heights of these plants ranges from species to species, most average arround 1-2 metres tall, one species, G.robusta, can reach heights of up to 40 metres. Over 300 (~360-380) species are endemic to Australia, with around a dozen species endemic to places outside Australia',
      leafShape: 'The sheer amount of different species means that there are many different ways the leaves can look, some dark green lines almost like blades of grass, some glossy green wide ones, and some with green leaves somewhat resembling tridents',
      leafImageUrl: 'assets/images/Grevillea_M_Morey_tree.jpg',
      plantShape: 'The different Grevillea species can range from small bushes with red flowers to a towering tree with yellow flowers',
      plantImageUrl: 'assets/images/Grevillea_M_Morey_tree.jpg',
      barkTexture: 'Spider Flowers range between bark types, with some being green and smooth, some being brown with red accents to brown rough bark',
      barkImageUrl: 'assets/images/Grevillea_M_Morey_tree.jpg',
      flowers: "The flowers of the Grevillea range between multiple colours, bright reds, oranges and pinks, to whites, yellows and black with green spots. Their common name reportably originates from them resembling a spider's web",
    ...
    Browse(
      ...
      description: "Syzygium Smithii is an evergreen tree which belongs to the Myrtaceae family. The tree can reach heights of up to 20 metres. It is endemic to Australia and its natural habitat is from North Queensland down to Southern Victoria",
      leafShape: 'The Lilly Pilly has green leaves which appear glossy and are widest in the middle',
      leafImageUrl: 'assets/images/Lilly_Pilly_M_Morey_leaf_COPYRIGHT.jpg',
      plantShape: 'The tree is very foliage dense, almost looking spherical when it is many years old',
      plantImageUrl: 'assets/images/Lilly_Pilly_M_Morey_tree.jpg',
      barkTexture: 'The bark of the Lilly Pilly is brown and rough, somewhat said to resemble scales',
      barkImageUrl: 'assets/images/Lilly_Pilly_M_Morey_tree.jpg',
      flowers: 'When grown, the flowers are coloured white and look spikey, additionally the Lilly Pilly can grow white coloured berries as well',
